...
def main_worker(gpu, ngpus_per_node, args):
    ...
    save_model(pruned_model_01, model_str+"_pruned_01_" + str(prune), pruned=True)
    save_out_history(out_history, model_str+"_pruned_01_" + str(prune))
    save_in_history(in_history, model_str+"_pruned_01_" + str(prune))
    ...
    save_model(pruned_model_02, model_str+"_pruned_02_" + str(prune) + "+" + str(prune_02), pruned=True)
    save_out_history(out_history_02, model_str+"_pruned_02_" + str(prune) + "+" + str(prune_02))
    save_in_history(in_history_02, model_str+"_pruned_02_" + str(prune) + "+" + str(prune_02))
